...
const collegeLocation = {
  latitude: 10.95509379382751,
  longitude: 77.9548367823787,
};
...
export default function HomeScreen() {
  ...
  const markAttendance = async (date, registerNumber) => {
    try {
      const apiUrl =
        "https://vsbec-placement-backend.onrender.com/student/markAttendance";
      ...
      if (response.ok) {
        ...
        console.error(
          "Error marking attendance on the backend:",
          response.statusText
        );
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.description}>
        Welcome to the Attendance App. Mark your attendance securely and
        effortlessly!
      </Text>
      <TouchableOpacity
